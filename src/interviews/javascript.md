...
- [1 - Qué devuelve la siguiente función?](#1---qué-devuelve-la-siguiente-función)
- [2 - Qué devuelve la siguiente función?](#2---qué-devuelve-la-siguiente-función)
- [3 - Qué devuelve la siguiente función?](#3---qué-devuelve-la-siguiente-función)
- [4 - Qué devuelve la siguiente función?](#4---qué-devuelve-la-siguiente-función)
- [5 - Cuál NO es válida?](#5---cuál-no-es-válida)
- [6 - Qué devuelve la siguiente función?](#6---qué-devuelve-la-siguiente-función)
- [7 - Qué devuelve la siguiente función?](#7---qué-devuelve-la-siguiente-función)
- [8 - Qué devuelve la siguiente función?](#8---qué-devuelve-la-siguiente-función)
- [9 - Qué devuelve la siguiente función?](#9---qué-devuelve-la-siguiente-función)
- [10 - Qué ocurre cuando hacemos esto?](#10---qué-ocurre-cuando-hacemos-esto)
- [11 - Qué devuelve la siguiente función?](#11---qué-devuelve-la-siguiente-función)
- [12 - Qué devuelve la siguiente función?](#12---qué-devuelve-la-siguiente-función)
- [13 - Cuáles son las tres fases de la propagación de eventos?](#13---cuáles-son-las-tres-fases-de-la-propagación-de-eventos)
- [14. All object have prototypes.](#14-all-object-have-prototypes)
- [15 - Qué devuelve la siguiente función?](#15---qué-devuelve-la-siguiente-función)
- [16 - Qué devuelve la siguiente función?](#16---qué-devuelve-la-siguiente-función)
- [17 - Qué devuelve la siguiente función?](#17---qué-devuelve-la-siguiente-función)
- [18 - Qué devuelve la siguiente función?](#18---qué-devuelve-la-siguiente-función)
- [19 - Qué devuelve la siguiente función?](#19---qué-devuelve-la-siguiente-función)
- [20 - Qué devuelve la siguiente función?](#20---qué-devuelve-la-siguiente-función)
- [21 - Cuál es el valor de `sum`?](#21---cuál-es-el-valor-de-sum)
- [22 - Cuánto tiempo es accesible cool_secret?](#22---cuánto-tiempo-es-accesible-cool_secret)
- [23 - Qué devuelve la siguiente función?](#23---qué-devuelve-la-siguiente-función)
- [24 - Qué devuelve la siguiente función?](#24---qué-devuelve-la-siguiente-función)
- [25 - Qué devuelve la siguiente función?](#25---qué-devuelve-la-siguiente-función)
- [26. El contexto de ejecución de JS crea dos cosas: el objecto global y la palabra reservada "this".](#26-el-contexto-de-ejecución-de-js-crea-dos-cosas-el-objecto-global-y-la-palabra-reservada-this)
- [27 - Qué devuelve la siguiente función?](#27---qué-devuelve-la-siguiente-función)
- [28 - Qué devuelve la siguiente función?](#28---qué-devuelve-la-siguiente-función)
- [29 - Qué devuelve la siguiente función?](#29---qué-devuelve-la-siguiente-función)
- [30 - Qué devuelve la siguiente función?](#30---qué-devuelve-la-siguiente-función)
- [31 - Cuál es la referencia al objeto que lanza el evento cuando se hace click en el botón?](#31---cuál-es-la-referencia-al-objeto-que-lanza-el-evento-cuando-se-hace-click-en-el-botón)
- [32. Al hacer click en el párrafo, ¿qué se muestra por pantalla?](#32-al-hacer-click-en-el-párrafo-qué-se-muestra-por-pantalla)
- [33 - Qué devuelve la siguiente función?](#33---qué-devuelve-la-siguiente-función)
- [34 - Qué devuelve la siguiente función?](#34---qué-devuelve-la-siguiente-función)
- [35 - Cuáles de estos valores son falsos?](#35---cuáles-de-estos-valores-son-falsos)
- [36 - Qué devuelve la siguiente función?](#36---qué-devuelve-la-siguiente-función)
- [37 - Qué devuelve la siguiente función?](#37---qué-devuelve-la-siguiente-función)
- [38 - Qué devuelve la siguiente función?](#38---qué-devuelve-la-siguiente-función)
- [39. Todo en Javascript es o bien un(a)..](#39-todo-en-javascript-es-o-bien-una)
- [40 - Qué devuelve la siguiente función?](#40---qué-devuelve-la-siguiente-función)
- [41 - Qué devuelve la siguiente función?](#41---qué-devuelve-la-siguiente-función)
- [42 - Qué devuelveel método `setInterval`?](#42---qué-devuelveel-método-setinterval)
- [43 - Qué devuelve la siguiente función?](#43---qué-devuelve-la-siguiente-función)
- [44 - Cuál es el resultado?](#44---cuál-es-el-resultado)
- [45 - Qué devuelve esto?](#45---qué-devuelve-esto)
- [46 - Cuál es el resultado?](#46---cuál-es-el-resultado)
- [47 - Cuál es el resultado?](#47---cuál-es-el-resultado)
- [48 - Cuál es el resultado?](#48---cuál-es-el-resultado)
- [49 - Cuál es el valor de `num`?](#49---cuál-es-el-valor-de-num)
- [50 - Cuál es el resultado?](#50---cuál-es-el-resultado)
- [51 - Cuál es el resultado?](#51---cuál-es-el-resultado)
- [52 - Cuál es el resultado?](#52---cuál-es-el-resultado)
- [53 - Cuál es el resultado?](#53---cuál-es-el-resultado)
- [54 - Cuál es el resultado?](#54---cuál-es-el-resultado)
- [55 - Cuál es el resultado?](#55---cuál-es-el-resultado)
- [56 - Cuál es el resultado?](#56---cuál-es-el-resultado)
- [57 - Cuál es el resultado?](#57---cuál-es-el-resultado)
- [58 - Cuál es el resultado?](#58---cuál-es-el-resultado)
- [59 - Cuál es el resultado?](#59---cuál-es-el-resultado)
- [60 - Cuál es el resultado?](#60---cuál-es-el-resultado)
- [61 - Cuál es el resultado?](#61---cuál-es-el-resultado)
- [62 - Cuál es el resultado?](#62---cuál-es-el-resultado)
- [63 - Cuál es el resultado?](#63---cuál-es-el-resultado)
- [64 - Cuál es el resultado?](#64---cuál-es-el-resultado)
- [65 - Cuál es el resultado?](#65---cuál-es-el-resultado)
- [66 - Con qué constructor podemos extender correctamente la clase `Dog`?](#66---con-qué-constructor-podemos-extender-correctamente-la-clase-dog)
- [67 - Cuál es el resultado?](#67---cuál-es-el-resultado)
- [68 - Cuál es el resultado?](#68---cuál-es-el-resultado)
- [69 - Cuál es el resultado?](#69---cuál-es-el-resultado)
- [70 - Cuál es el resultado?](#70---cuál-es-el-resultado)
- [71 - Cómo puedes mostrar por consola los valores comentados junto a las sentencias console.log?](#71---cómo-puedes-mostrar-por-consola-los-valores-comentados-junto-a-las-sentencias-consolelog)
- [72 - Cuál es el resultado?](#72---cuál-es-el-resultado)
- [73 - Cuál es el resultado?](#73---cuál-es-el-resultado)
- [74 - Cuál es el resultado?](#74---cuál-es-el-resultado)
- [75 - Cuál es el resultado?](#75---cuál-es-el-resultado)
- [76 - Cuál es el resultado?](#76---cuál-es-el-resultado)
- [77 - Esta es una función pura?](#77---esta-es-una-función-pura)
- [78 - Cuál es el resultado?](#78---cuál-es-el-resultado)
- [79 - Cuál es el resultado?](#79---cuál-es-el-resultado)
- [80 - Cuál es el resultado?](#80---cuál-es-el-resultado)
- [81 - Cuál es el resultado?](#81---cuál-es-el-resultado)
- [82 - Cuál es el resultado?](#82---cuál-es-el-resultado)
- [83 - Cuál es el resultado?](#83---cuál-es-el-resultado)
- [84 - Cuál es el resultado?](#84---cuál-es-el-resultado)
- [85 - Qué tipo de información se mostrará por consola?](#85---qué-tipo-de-información-se-mostrará-por-consola)
- [86 - Qué opción es una forma de igualar `hasName` a `true`, teniendo en cuenta que no se puede pasar `true` como argumento?](#86---qué-opción-es-una-forma-de-igualar-hasname-a-true-teniendo-en-cuenta-que-no-se-puede-pasar-true-como-argumento)
- [87 - Cuál es el resultado?](#87---cuál-es-el-resultado)
- [88 - Cuál es el resultado?](#88---cuál-es-el-resultado)
- [89 - Cuál es el resultado?](#89---cuál-es-el-resultado)
- [90 - Cuál es el resultado?](#90---cuál-es-el-resultado)
- [91 - Cuál es el resultado?](#91---cuál-es-el-resultado)
- [92 - Cuál es el resultado?](#92---cuál-es-el-resultado)
- [93 - Cuál es el resultado?](#93---cuál-es-el-resultado)
- [94 - Cuál es el resultado?](#94---cuál-es-el-resultado)
- [95 - Cuál es el resultado?](#95---cuál-es-el-resultado)
- [96 - Cuál es el resultado?](#96---cuál-es-el-resultado)
- [97 - Cuál es el resultado?](#97---cuál-es-el-resultado)
- [98 - Cuál es el resultado?](#98---cuál-es-el-resultado)
- [99 - Cuál es el resultado?](#99---cuál-es-el-resultado)
- [100 - Cuál es el valor de la salida?](#100---cuál-es-el-valor-de-la-salida)
- [101 - Cuál es el valor de la salida?](#101---cuál-es-el-valor-de-la-salida)
- [102 - Cuál es el valor de la salida?](#102---cuál-es-el-valor-de-la-salida)
- [103 - Cuál es el valor de la salida?](#103---cuál-es-el-valor-de-la-salida)
- [104 - Cuál es el valor?](#104---cuál-es-el-valor)
- [105 - Cuál es el valor?](#105---cuál-es-el-valor)
- [106 - Cuál es el valor?](#106---cuál-es-el-valor)
- [107 - Cuál es el valor?](#107---cuál-es-el-valor)
- [108 - Cuál de estos métodos modifica el array original?](#108---cuál-de-estos-métodos-modifica-el-array-original)
- [109 - Cuál es el resultado?](#109---cuál-es-el-resultado)
- [110 - Qué hace este método?](#110---qué-hace-este-método)
- [111 - Cuál es el resultado?](#111---cuál-es-el-resultado)
- [112 - Cuál es el resultado?](#112---cuál-es-el-resultado)
- [113 - Cuál es el resultado?](#113---cuál-es-el-resultado)
- [114 - Qué ocurrirá?](#114---qué-ocurrirá)
- [115 - Qué método(s) devolverá el valor `'Hello world!'`?](#115---qué-métodos-devolverá-el-valor-hello-world)
- [116 - Cuál es el resultado?](#116---cuál-es-el-resultado)
